      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            Be sure to use
            {' '}
            <code>.col-form-label-sm</code>
            {' '}
            or
            {' '}
            <code>.col-form-label-lg</code>
            {' '}
            to
            your
            {' '}
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            ...
            take up more or less space, while the remaining
            <code>&lt;CCol&gt;</code>
            s equally
